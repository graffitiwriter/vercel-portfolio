...
```
Swap out "/source" for the subpage you're redirecting from ("/hello-vercel", in your case), and change the destination to the URL you're sending people to. Once that's deployed, you should be good to go!

Always good to hear other people's methods too, so please share any other solutions in here. And if you get stuck, you know where to find us!
...
It can take a day or two for nameserver changes to propogate through the Internet, so don't worry if it doesn't instantly work.
